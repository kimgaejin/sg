...
namespace CTS
{
    ...
    public class CompleteTerrainShaderEditor : PWEditor
    {
...
//            {
//                EditorUtility.DisplayDialog("World Manager API", "World Manager is not present in your project. Please go to https://github.com/adamgoodrich/WorldManager to learn about it.", "OK");
...
//        }
        ...
        {
            Application.OpenURL("https://assetstore.unity.com/publishers/6887");
        }
...
#region Setup and introduction
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                EditorPrefs.SetBool(prefString, EditorGUILayout.Toggle(EditorPrefs.GetBool(prefString, false),GUILayout.Width(15)));
                EditorGUILayout.LabelField("News Enabled", GUILayout.Width(82));
            }
            ...
            if (m_globalHelp)
            {
                ...
                {
                    Application.OpenURL("https://www.procedural-worlds.com/products/indie/cts-complete-terrain-shader/cts-tutorials/");
                }
            }
